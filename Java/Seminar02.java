...
public class Main {
    private static Logger logger = Logger.getLogger(Main.class.getName()); //Метод лог файл
    public static void main(String[] args) {
//        fillWithCharacters(6);
//        changeString();
//        System.out.println(isPalindrome("a b a b"));
//        createTestString();
//        createTestString();
//        checkFileFolders();
    }
    ...
    private static void checkFileFolders() {
        ...
        } catch (FileNotFoundException e) { //catch - Отработка возможных ошибок
